...
HEADERS = {"User-Agent": "PyPixelatedProxies/1.0"}
API_DELAY = 0.5
LAST_FETCH = 0.0
# COMMENT OUT TO SHOW REMINDER TEXT 
# TODO: MAKE A ENV TOGGLE 
# DO NOT FORGET TO SWAP U+2019 to U+0027
REMOVAL_LINES = [
...
class CardFace:
    ...
    def __init__(self, card_face, path, layout):
        ...
        if layout in [Layout.ADVENTURE, Layout.SAGA, Layout.CLASS, Layout.PREPARE]:
